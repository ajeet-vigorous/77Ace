 ...
 useEffect(() => {
  ...
  return (
    ...
    <div className="w-full px-5 ">
       ...
       <div className={`grid   bg-white/5 backdrop-blur-sm h-[56px] ${token ? 'grid-cols-2' : 'grid-cols-1'} items-center justify-center`} style={{boxShadow:'0.2px -0.2px  white'}}>
      ...
      {activeTab == 'promo' && <div className='w-full h-[2px] bg-[#F44336] shadow-[0px_-20px_40px_7px_#F44336] absolute bottom-1'></div>}
       ...
       {token && <div className='flex items-center  h-full justify-center cursor-pointer' onClick={() => {setActiveTab('vip');setActiveScreen('vip')}}>
