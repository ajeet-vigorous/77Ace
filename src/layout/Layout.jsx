...
>
        ...
        <div className="flex-1 overflow-hidden relative">
          ...
          <div  className="flex absolute bottom-32 right-2  w-[63px] h-[63px] rounded-full text-white bg-gradient-to-t from-[#a31717] via-[#d41616] to-[#ee7474] items-center justify-center">
