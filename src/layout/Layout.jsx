...
const Layout = () => {
  ...
  const isAddCashPage = ['/addcash', '/addbank','/personalinfo'].includes(location.pathname);
          ...
          {!isAddCashPage && (
            <>
              <div className="h-[69px] shrink-0">
                <AppHeader toggleSidebar={toggleSidebar} toggleSubHeader={toggleSubHeader} />
              </div>
              ...
              <div className="flex-1 overflow-hidden relative">
                ...
                {sidebarOpen.subHeaderOpen && (
                  <>
                    <div className="absolute inset-0 z-40 bg-black bg-opacity-50" onClick={toggleSubHeader} />
